        ...
        return (
            <div className="beer-form">
                <form className="add-beer" onSubmit={this.handleSubmit} >
                    ...
                    <br />
                    <input onChange={this.handleChange} type="text" name="image" placeholder="Enter of image beer..." className="input-text" />
                    <br />
                    <input onChange={this.organicState} type="checkbox" value="organic" className="input-text" />Organic?
                    <br />
                    <input onChange={this.handleChange} type="text" name="location" placeholder="Enter brewing location..." className="input-text" />
                    <br />
